...
public class CallController {
    ...
    private final IHistoryService callHistory;
    ...
    public ResponseEntity<List<CallDto>> getAllCallsByIDFirst(@PathVariable Long orderId){
        return ResponseEntity.ok(callHistory.getAllCallsByIDLatestFirst(orderId));
    }
